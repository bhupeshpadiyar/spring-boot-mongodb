...
import com.bhupeshji.springbootmongodb.models.Booking;
import com.bhupeshji.springbootmongodb.models.BookingRepository;
...
public class BookingController {
	...
	public Map<String, Object> create(Booking booking) {
		...
		dataMap.put("booking", bookingRepository.save(booking));
		return dataMap;
	}
	...
	public Map<String, Object> read(@RequestParam String bookingId) {
		...
		Object booking = bookingRepository.findById(bookingId);
		Map<String, Object> dataMap = new HashMap<String, Object>();
	 ...
	 * String bookingId, @RequestParam String psngrName) {
	 * 
	 * 
	 * Booking booking = bookingRepository.findOne()
	 * booking.setPsngrName(psngrName); booking = bookingRepository.save(booking);
	 * Map<String, Object> dataMap = new HashMap<String, Object>();
	 * dataMap.put("message", "Booking updated successfully"); dataMap.put("status",
	 * "1"); dataMap.put("booking", booking); return dataMap; }
	 */
